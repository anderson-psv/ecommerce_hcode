...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="/res/admin/plugins/iCheck/flat/blue.css">
  <!-- Morris chart -->
  <link rel="stylesheet" href="/res/admin/plugins/morris/morris.css">
  <!-- jvectormap -->
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="/res/admin/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/admin/products"><i class="fa fa-gears"></i><span>Produtos</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>