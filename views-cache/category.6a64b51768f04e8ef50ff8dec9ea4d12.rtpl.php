            ...
            <div class="col-md-3 col-sm-6">
                <div class="single-shop-product">
                    ...
                    <div class="product-carousel-price">
                        <ins>$<?php echo formatPrice($value1["vlprice"]); ?></ins> <del>$999.00</del>
                    </div>  
            ...
            <div class="col-md-12">
                <div class="product-pagination text-center">
                    <nav>
                        ...
                        <li>
                            <a href="/categories/<?php echo htmlspecialchars( $category["idcategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?>?page=<?php echo htmlspecialchars( $currentpage - 1, ENT_COMPAT, 'UTF-8', FALSE ); ?>" aria-label="Previous">
                        ...
                        <li>
                            <a href="/categories/<?php echo htmlspecialchars( $category["idcategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?>?page=<?php echo htmlspecialchars( $currentpage + 1, ENT_COMPAT, 'UTF-8', FALSE ); ?>" aria-label="Next">
                            <span aria-hidden="true">»</span>
                            </a>
                        </li>
                        <?php } ?>
