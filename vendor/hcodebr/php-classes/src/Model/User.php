...
class User extends Model
{
    ...
    public static function getForgot($email)
    {
        ...
        else
        {
            ...
            $res_user = $sql->select("CALL sp_userspasswordsrecoveries_create(:iduser, :desip)", array(
                ":iduser"=>$data["iduser"],
    ...
    {
        $sql = new Sql();
        $results = $sql->query("UPDATE tb_userspasswordsrecoveries
            SET dtrecovery = NOW()
